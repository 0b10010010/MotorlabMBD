classdef DigitalOut < matlab.System ...
    ...
    methods
        % Constructor
        function obj = DigitalOut(varargin)
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, context)
            if context.isCodeGenTarget('rtw')
                ...
                % linker flags
                addIncludeFiles(buildInfo,'DigitalOut.h');         
...
%                 addSourceFiles(buildInfo,'stm32f4xx_tim.c', srcDir);
                addSourceFiles(buildInfo,'DigitalOut.c',srcDir);
