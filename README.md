...
The board is setup to write to GPIO to check the loop frequency and it is exactly at 10kHz. -> When sending USART, it rasises the time GPIO pin goes high to total of about 50 microseconds (loop is running at 100microseconds).
